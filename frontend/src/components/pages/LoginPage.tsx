...
import { LoginRequestType } from '@type/Auth';
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ width: '75%' }}>
          <Flex direction={'column'} width="100%" height="200px" marginTop="25%">
            <FormControl isInvalid={errors.email !== undefined} width={'100%'} marginBottom={10}>
              <FormLabel htmlFor="email">Email</FormLabel>
              <TextInput id="email" type="email" placeholder="Email" {...register('email')} />
              <FormErrorMessage>{errors.email && errors.email.message}</FormErrorMessage>
            </FormControl>
            <FormControl isInvalid={errors.password !== undefined} width={'100%'}>
